...
int main(int argc, char** argv)
{
    ...
    widthOption.setDefaultValue(QStringLiteral("1000"));
    ...
    heightOption.setDefaultValue(QStringLiteral("1000"));
    ...
    QCommandLineOption maxIterationsOption(QStringList() << QStringLiteral("i") << QStringLiteral("max-iterations"),
        ...
        QStringLiteral("iterations"));
    maxIterationsOption.setDefaultValue(QStringLiteral("1000"));
    ...
    if (parser.isSet(benchmarkOption)) {
        ...
        const int height = parser.value(heightOption).toUInt();
